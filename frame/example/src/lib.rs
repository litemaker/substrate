...
//! code.</li> <li>Identifiers - surround by backticks (i.e. <code>INHERENT_IDENTIFIER</code>,
//! <code>InherentType</code>,  <code>u64</code>)</li> <li>Usage scenarios - should be simple
//! doctests. The compiler should ensure they stay valid.</li> <li>Extended tutorials - should be
//! moved to external files and refer to.</li> <!-- Original author of paragraph: @AmarRSingh -->
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn set_dummy(
			...
			// Print out log or debug message in the console via
